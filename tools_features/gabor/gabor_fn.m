function gb=gabor_fn(bw,gamma,psi,lambda,theta, GaborSize)
% bw    = bandwidth, (1)
...
if GaborSize == 0
    gamma = 0.5; % usually default set as 0.5
else
    disp(sprintf('resize Gabor function, check gamma in gabor_fn.m, GaborSize: %d',GaborSize));
    gamma = 0.01;
end
